export const API_BASE_URL = 'https://spider.nitt.edu/nitt-app/v1.1';

export const API_STUDENT_LOGIN = API_BASE_URL + '/auth/student/login';
export const API_CLUB_LOGIN = API_BASE_URL + '/auth/club/login';
export const API_STUDENT_REGISTER = API_BASE_URL + '/auth/student/register';
...
export const KEY_IS_STUDENT = 'is_student';
